...
<figure class="${"svelte-1kk9opm"}"><img alt="${"Borat"}" src="${"maskot 1.svg"}" class="${"svelte-1kk9opm"}">
...
const Payment = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<link rel="${"stylesheet"}" href="${"tutorial/dark-theme.css"}" class="${"svelte-yhmcz5"}">${($$result.title = `<title>Payment</title>`, "")}`, "")}
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1dbd5up"}"><ul class="${"svelte-1dbd5up"}"><li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-1dbd5up"}">home</a></li>
		...
		<li class="${"svelte-1dbd5up"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === "payment" ? "page" : undefined, 0)} href="${"payment"}" class="${"svelte-1dbd5up"}">test</a></li>
