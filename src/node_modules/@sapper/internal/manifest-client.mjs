...
export const components = [
	...
	{
		js: () => import("../../../routes/information.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:information.svelte__"
	},
	{
		js: () => import("../../../routes/payment.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:payment.svelte__"
	},
	{
...
if (typeof window !== 'undefined') {
	import("E:/Framework/sapper/node_modules/sapper/sapper-dev-client.js").then(client => {
